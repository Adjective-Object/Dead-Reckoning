...
public class MainMenuState extends BasicGameState
{
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException {
		...
		if((mouseX >= optionsX && mouseX <= optionsX + optionsButton.getWidth())
				&& (mouseY >= optionsY && mouseY <= optionsY + optionsButton.getHeight()))
				inOptions = true;
		else inOptions = false;
		
		if((mouseX >= creditsX && mouseX <= creditsX + creditsButton.getWidth())
				&& (mouseY >= creditsY && mouseY <= creditsY + creditsButton.getHeight()))
				inCredits = true;
