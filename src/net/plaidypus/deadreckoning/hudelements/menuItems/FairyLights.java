...
public class FairyLights extends HudElement{
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
		...
		for(int i=0; i<particles.length; i++){
			...
			g.drawImage(this.particleSheet.getSprite((int)particles[i][0]%this.particleSheet.getHorizontalCount(), (int)particles[i][0]/this.particleSheet.getVerticalCount()),
