...
public class TextEntryBox extends HudElement{
	...
	public TextEntryBox(int x, int y, int bindMethod,
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
		...
		g.drawString(this.content,getX()+getWidth()-DeadReckoningGame.menuFont.getWidth(content),getY()+this.getHeight()/2 - DeadReckoningGame.menuFont.getHeight(content)/2);
		g.clearClip();
	}
