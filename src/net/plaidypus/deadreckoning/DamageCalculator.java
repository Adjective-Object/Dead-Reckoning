...
public class DamageCalculator {
	...
	public static boolean checkHits(LivingEntity attacker, LivingEntity defender){
		...
		double hitRate=  100+Math.sqrt(accuracy)-Math.sqrt(avoidability);
	...
	public static int getMagicalDamage(LivingEntity attacker, LivingEntity defender, int attackPower){
		
	}
	
	public static int calculateMaxDamage(double attackSum, double defenseSum, int attackPower){
		
	}
	
	public static int calculateMinDamage(double attackSum, double defenseSum, int attackPower){
