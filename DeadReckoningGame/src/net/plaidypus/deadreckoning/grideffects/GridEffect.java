 ...
 * 
 * GridEffects are a method of putting animations / etc tied to the grid of a
 * GameBoard they can be stored as above or below the entities in the tile.
 * 
 */
public abstract class GridEffect {
	 ...
	 * 
	 * @param delta
	 *            the milliseconds passed since the last update call
	 */
	public abstract void update(int delta);

	/**
	 * Renders at the x,y offset (given in terms of tiles offset - number of
	 * tiles shifted out of screen).
	 * 
	 * @param g
	 *            the g
	 * @param xoff
	 *            the xoff in tile offset
	 * @param yoff
	 *            the yoff in tiel offset
	 */
