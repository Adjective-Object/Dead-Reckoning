...
public class Fireball extends Skill {
	...
	public Fireball() {
		super(image);
		System.out.println("Image at initialization is "+image);
	 ...
	 */
	public static void init() throws SlickException {//TODO things
		try {
			fireball = new SpriteSheet( new Image(TextureLoader.getTexture("PNG",ModLoader.getModpackLoader("core").getResourceAsStream("core/res/FireBurst.png")) ),
					DeadReckoningGame.tileSize, DeadReckoningGame.tileSize);
			image = new Image(TextureLoader.getTexture("PNG",ModLoader.getModpackLoader("core").getResourceAsStream("core/res/onFireIcon.png")));
