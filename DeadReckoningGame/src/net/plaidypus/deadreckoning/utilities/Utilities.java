...
public class Utilities {
	...
	public static void addAllExclusivley(ArrayList<Tile> target, ArrayList<Tile> toAdd){
		target.ensureCapacity(target.size()+toAdd.size());
		for(int i=0; i<toAdd.size() ;i++){
			if(!target.contains(toAdd.get(i))){
